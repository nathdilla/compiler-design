...
{
      11,     0,    -1,    12,    14,    -1,    -1,    13,    12,    -1,
       3,     4,     5,    -1,     3,     4,    -1,    -1,    15,    14,
      -1,     4,     6,    16,     5,    -1,     9,     4,     5,    -1,
       4,    17,     4,    -1,     4,    -1,     8,    -1,     7,    -1
};
...
{
  "$end", "error", "$undefined", "TYPE", "ID", "SEMICOLON", "EQ", "PLUS",
  "NUMBER", "WRITE", "$accept", "Program", "VarDeclList", "VarDecl",
...
#line 85 "parser.y"
    { /* code TBD */
								...
								(yyval.ast)->stmt.varName = strdup((yyvsp[(1) - (4)].string));
								(yyval.ast)->stmt.operator = (yyvsp[(2) - (4)].operator);
								(yyval.ast)->stmt.expr = (yyvsp[(3) - (4)].ast);
								// Set other fields as necessary
 ;}
    break;
