...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VarDeclList = 22,               /* VarDeclList  */
  YYSYMBOL_VarDecl = 23,                   /* VarDecl  */
  YYSYMBOL_FuncDeclList = 24,              /* FuncDeclList  */
  YYSYMBOL_FuncDecl = 25,                  /* FuncDecl  */
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "LBRACK", "RBRACK", "LPAREN", "RPAREN", "COMMA", "EQ",
  "PLUS", "MINUS", "STAR", "BSLASH", "NUMBER", "WRITE", "RETURN", "FUNC",
  "$accept", "Program", "VarDeclList", "VarDecl", "FuncDeclList",
  "FuncDecl", "ParamList", "Param", "Block", "$@1", "$@2", "StmtList",
  "Stmt", "Expr", "BinOp", YY_NULLPTR
};
...
{
       8,     1,    13,    -2,     8,     9,   -10,    12,    20,    22,
      -1,    10,   -10,    -1,   -10,   -10,     2,    21,    23,   -10,
     -10,   -10,   -10,   -10,     7,   -10,    24,   -10,   -10,   -10,
     -10,   -10,     2,    25,    -5,    26,    28,    29,   -10,    27,
      25,   -10,   -10,   -10,     8,    -1,   -10,    31,   -10
};
...
{
       4,     0,     0,     7,     4,     0,     1,     0,     0,     0,
      17,     7,     3,    17,     5,     6,     0,     0,     0,     2,
       8,    18,    22,    23,     0,    20,     0,    19,    24,    25,
      26,    27,     0,    10,    21,     0,     0,    11,    13,     0,
      10,    14,     9,    12,     4,    17,    15,     0,    16
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -10,   -10,    -4,   -10,    30,   -10,    -6,   -10,   -10,   -10,
     -10,    -9,   -10,     3,   -10
};
...
{
      14,    19,     7,     7,    21,     5,    22,    28,    29,    30,
      31,     1,    27,     6,    15,     8,     8,     9,    23,    28,
      29,    30,    31,    16,    17,    18,    25,    26,    35,     9,
      38,     0,    33,    41,    43,    34,    46,    39,    48,    40,
      45,    20
};

static const yytype_int8 yycheck[] =
{
       4,    10,     4,     4,    13,     4,     4,    12,    13,    14,
      15,     3,     5,     0,     5,    17,    17,    19,    16,    12,
      13,    14,    15,    11,     4,     3,     5,     4,     3,    19,
       4,    -1,     8,     6,    40,    32,    45,     9,     7,    10,
      44,    11
};
...
static const yytype_int8 yystos[] =
{
      ...
      24,    25,    31,    32,    22,     5,    11,     4,     3,    31,
      24,    31,     4,    16,    33,     5,     4,     5,    12,    13,
      14,    15,    34,     8,    33,     3,    26,    27,     4,     9,
      10,     6,    28,    26,    29,    22,    31,    30,     7
};
...
#line 76 "parser.y"
									...
									root->program.stmtList = (yyvsp[-1].ast);
									}
...
#line 1220 "parser.tab.c"
  ...
  case 7: /* FuncDeclList: %empty  */
#line 124 "parser.y"
                                                                                {/*empty, i.e. it is possible not to declare a variable*/}
#line 1226 "parser.tab.c"
    break;

  case 8: /* FuncDeclList: FuncDecl FuncDeclList  */
#line 125 "parser.y"
                                                        {  
...
#line 1239 "parser.tab.c"
  ...
  case 9: /* FuncDecl: FUNC TYPE ID LPAREN ParamList RPAREN Block  */
#line 137 "parser.y"
                                                                        { 
									...
									(yyval.ast)->funcDecl.funcType = strdup((yyvsp[-5].string));
									(yyval.ast)->funcDecl.funcName = strdup((yyvsp[-4].string));
...
#line 1271 "parser.tab.c"
  ...
  case 12: /* ParamList: Param COMMA ParamList  */
#line 157 "parser.y"
                                                { 
...
#line 1316 "parser.tab.c"
  ...
  case 16: /* Block: LBRACK $@1 VarDeclList StmtList $@2 RBRACK  */
#line 189 "parser.y"
                        { 
				printf("PARSER: Recognized block\n"); 
				(yyval.ast) = malloc(sizeof(ASTNode));
				(yyval.ast)->type = NodeType_Block;
				(yyval.ast)->block.varDeclList = (yyvsp[-3].ast);
				(yyval.ast)->block.stmtList = (yyvsp[-2].ast);
			}
...
#line 1345 "parser.tab.c"
  ...
  case 19: /* Stmt: ID EQ Expr SEMICOLON  */
#line 210 "parser.y"
                                        {
...
#line 1364 "parser.tab.c"
  ...
  case 20: /* Stmt: WRITE ID SEMICOLON  */
#line 224 "parser.y"
                                                {
