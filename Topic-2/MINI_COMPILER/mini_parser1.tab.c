...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_VarDeclList = 17,               /* VarDeclList  */
  YYSYMBOL_VarDecl = 18,                   /* VarDecl  */
  YYSYMBOL_StmtList = 19,                  /* StmtList  */
  YYSYMBOL_Stmt = 20,                      /* Stmt  */
  YYSYMBOL_Expr = 21,                      /* Expr  */
  YYSYMBOL_BinOp = 22                      /* BinOp  */
};
...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "EQ", "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "LPAREN",
  "RPAREN", "NUMBER", "WRITE", "$accept", "Program", "VarDeclList",
  "VarDecl", "StmtList", "Stmt", "Expr", "BinOp", YY_NULLPTR
};
...
{
       0,     3,    16,    17,    18,     4,     0,     4,    14,    19,
      20,    17,     5,     6,     4,    19,     4,    13,    21,     5,
       7,    22,     5,     4
};
                       ...
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep)
{
  ...
  switch (yykind)
    {
    case YYSYMBOL_ID: /* ID  */
#line 40 "mini_parser1.y"
         { fprintf(yyoutput, "%s", ((*yyvaluep).string)); }
#line 718 "mini_parser1.tab.c"
        break;
...
#line 1134 "mini_parser1.tab.c"
    break;

  case 5: /* VarDecl: TYPE ID SEMICOLON  */
#line 69 "mini_parser1.y"
...
#line 1172 "mini_parser1.tab.c"
    break;

  case 9: /* Stmt: ID EQ Expr SEMICOLON  */
#line 90 "mini_parser1.y"
                           { /* code TBD */
								printf("PARSER: Recognized assignment statement\n");
								(yyval.ast) = malloc(sizeof(ASTNode));
								(yyval.ast)->type = NodeType_Stmt;
								(yyval.ast)->stmt.varName = strdup((yyvsp[-3].string));
								(yyval.ast)->stmt.operator = (yyvsp[-2].operator);
								(yyval.ast)->stmt.expr = (yyvsp[-1].ast);
								// Set other fields as necessary
 }
#line 1186 "mini_parser1.tab.c"
    break;

  case 10: /* Stmt: WRITE ID SEMICOLON  */
#line 99 "mini_parser1.y"
                             { printf("PARSER: Recognized write statement\n"); }
#line 1192 "mini_parser1.tab.c"
    break;

  case 11: /* Expr: ID BinOp ID  */
#line 102 "mini_parser1.y"
                  { 
...
#line 1208 "mini_parser1.tab.c"
    break;

  case 12: /* Expr: ID  */
#line 113 "mini_parser1.y"
             { printf("ASSIGNMENT statement \n"); }
#line 1214 "mini_parser1.tab.c"
    break;

  case 13: /* Expr: NUMBER  */
#line 114 "mini_parser1.y"
                 { 
...
#line 1226 "mini_parser1.tab.c"
    break;

  case 14: /* BinOp: PLUS  */
#line 123 "mini_parser1.y"
            { /* code TBD */ }
#line 1232 "mini_parser1.tab.c"
    break;


#line 1236 "mini_parser1.tab.c"
